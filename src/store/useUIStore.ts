...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Premium equipment rental and specialized construction services.',
    'hero.cta': 'Explore Shop',
    'shop.title': 'Equipment Catalog',
    'shop.filters': 'Filters',
    'shop.category': 'Category',
    'shop.price': 'Price',
    'shop.rent_now': 'Rent Now',
    'product.per_day': 'per day',
  ...
  pt: {
    ...
    'hero.subtitle': 'Aluguer de equipamentos premium e serviços de construção especializados.',
    'hero.cta': 'Explorar Loja',
    'shop.title': 'Catálogo de Equipamentos',
    'shop.filters': 'Filtros',
    'shop.category': 'Categoria',
    'shop.price': 'Preço',
    'shop.rent_now': 'Alugar Agora',
    'product.per_day': 'por dia',
    'product.book': 'Reservar Agora',
